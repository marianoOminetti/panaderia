...
import { calcularGastosFijosNormalizados } from "../gastos/GastosFijos";
...
export default function Analytics({ ventas, recetas, clientes, recetaIngredientes, insumos, gastosFijos }) {
  const hoy = new Date();
  ...
  return (
    <div className="content">
      ...
      <AnalyticsSemana
        ingresoSemanaActual={ingresoSemanaActual}
        ingresoSemanaAnterior={ingresoSemanaAnterior}
        costoSemanaActual={costoSemanaActual}
        costoSemanaAnterior={costoSemanaAnterior}
        gananciaSemanaActual={gananciaSemanaActual}
        gananciaSemanaAnterior={gananciaSemanaAnterior}
        margenSemanaActual={margenSemanaActual}
        trendIngreso={trendIngreso}
        trendCosto={trendCosto}
        trendGanancia={trendGanancia}
        trendMargen={trendMargen}
        topMasVendidos={topMasVendidos}
        topMasRentables={topMasRentables}
        maxIngreso7={maxIngreso7}
        ultimo7diasFechas={ultimo7diasFechas}
        ingresoPorDia7={ingresoPorDia7}
        diasSemanaCorto={diasSemanaCorto}
        totalIngresos7={totalIngresos7}
        pieData={pieDataWithColor}
        pieGradient={pieGradient}
      />

      <AnalyticsProductos
        diaPicoLabel={diaPicoLabel}
        horaPicoLabel={horaPicoLabel}
        mejorCliente={mejorCliente}
        mejorClienteTotal={mejorClienteTotal}
        proyIngresoMes={proyIngresoMes}
        ingresoMes={ingresoMes}
        diasTranscurridos={diasTranscurridos}
        proyGananciaMesNeta={proyGananciaMesNeta}
        gananciaMesNeta={gananciaMesNeta}
        recetasSinVenta7={recetasSinVenta7}
      />
