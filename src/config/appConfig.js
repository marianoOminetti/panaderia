...
export const CATEGORIAS = ["Harinas", "Lácteos", "Azúcares", "Chocolates", "Rellenos", "Proteínas", "Condimentos", "Packaging"];
...
export const DIAS_ALERTA_AMARILLA = 4;          // < 4 días → alerta amarilla
export const DIAS_OBJETIVO_PRODUCCION = 3;      // Objetivo de cobertura para sugerencias de producción
